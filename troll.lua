-- TROLL PLAYER HUB - FIXED DRAGGABLE HEADER & ALL FEATURES (ENGLISH)
...
-- Top Drag Bar (Khu vực chuyên để cầm kéo menu cho mượt)
...
OwnerLabel.Text = "(owner name roblox toichimuonc)"
OwnerLabel.TextColor3 = Color3.fromRGB(160, 160, 160)
OwnerLabel.TextSize = 10
OwnerLabel.Font = Enum.Font.SourceSansItalic
OwnerLabel.Parent = DragBar

-- Hàm kéo thả chuẩn mượt trên mobile (Chỉ kéo qua DragBar và OpenBtn)
local function makeDraggable(obj, targetWindow)
    ...
    UserInputService.InputChanged:Connect(function(input)
        if input == dragInput and dragging then
            ...
            targetWindow.Position = UDim2.new(startPos.X.Scale, startPos.X.Offset + delta.X, startPos.Y.Scale, startPos.Y.Offset + delta.Y)
        end
    end)
end
